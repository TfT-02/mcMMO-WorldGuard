# mcMMO-WorldGuard
## mcMMO WorldGuard features

### Brief Description
mcMMO-WorldGuard is an extra plugin for mcMMO. It uses WorldGuard to give certain players modified XP gains, depending on whether or not they are inside specific regions. And it is used to enable/disable mcMMO abilities in specified regions.
...
mcMMO-WorldGuard uses Maven 3 to manage dependencies, packaging, and shading of necessary classes; Maven 3 is required to compile mcMMO.
