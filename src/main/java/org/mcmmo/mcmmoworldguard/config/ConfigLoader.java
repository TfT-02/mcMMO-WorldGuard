...
public abstract class ConfigLoader {
    protected static final mcMMOWorldGuard plugin = mcMMOWorldGuard.p;
    ...
    protected void loadFile() {
        if (!configFile.exists()) {
            plugin.debug("Creating mcMMO-WorldGuard " + fileName + " File...");
            ...
            plugin.debug("Loading mcMMO-WorldGuard " + fileName + " File...");
        }
    ...
    protected void validate() {
        if (validateKeys()) {
            ...
            plugin.getLogger().warning("Errors were found in " + fileName + "! mcMMO-WorldGuard was disabled!");
